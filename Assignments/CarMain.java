...
{   public static int GOAL = -1;
   ...
   {
        mine.addMiles(miles);
        System.out.println("The car added " + miles + " and now has " + mine.getMiles());
   }
   ...
   public static void driveTest(Car car1, Car car2)
   {
       ...
       //verifies both cars can race
       {
          while (count1 < GOAL && count2 < GOAL)
          {
            ...
            //check how many miles left in the car has before. Then, subtracting the miles before to after
             ...
             System.out.print("before " + milesBefore1);
             ...
             double milesAfter1 = car1.getFuelLevelInMiles();
                  System.out.print("after " + milesAfter1);
      ...
      //If neither can race
      {
        System.out.print("Both cars do not have enough fuel in their tank to race :(");
        }
      else if (!(car1CanRace))
      {
        System.out.print(car1.getModel() + " does not have enough fuel in its tank to race :(");
        }
      else if (!(car2CanRace))
      {
        System.out.print(car2.getModel() + " does not have enough fuel in its tank to race :(");
        }
      
      //Print out who won  
      if ((count1 >= GOAL) && (count2 >= GOAL))
          System.out.print(car1.getModel() + " and " + car2.getModel() + " tied!");
      else if(count1 >= GOAL)
          System.out.print(car1.getModel() + " won!");
      else if(count2 >= GOAL)
          System.out.print(car2.getModel() + " won!");
    }
